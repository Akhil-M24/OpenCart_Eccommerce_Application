...
public class ExcelFileUtility {
	...
	public int getCellData(String sheetName,int rownum) throws IOException
	{
		fi=new FileInputStream(path);
		workbook=new XSSFWorkbook(fi);
		sheet=workbook.getSheet(sheetName);
	...
	public void setCellData(String sgeetName,int rownum,int colnum,String data) throws IOException
	{
